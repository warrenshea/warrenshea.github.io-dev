...
const remove_focus_selector = `.form\\:theme\\:b33mOe input[type="radio"]+label, .form\\:theme\\:b33mOe input[type="text"]+label, .form\\:theme\\:b33mOe input[type="email"]+label, [data-module="popover"] button, [data-module="popover"] a`;
